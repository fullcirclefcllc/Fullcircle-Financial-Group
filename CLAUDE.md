# CLAUDE.md — FullCircle Financial Group
## Context for every Claude Code session

Read this file at the start of every session. This is the full context of who Breyon is, what FCFG does, what has been built, and what the goals are.
...
**Name:** Breyon Miller  
**Company:** FullCircle Financial Group (FCFG)  
...
FullCircle Financial Group is a **financial architecture firm** — we don't sell products in isolation, we design complete financial systems for high-income professionals.
...
## Target Clients (Ideal Client Avatars)

**Primary — "The Producing Pro":** Real estate agents, mortgage brokers, insurance producers, consultants. $150K–$400K/yr, 1099, no structure, paying max taxes, personal assets exposed.

**Secondary — "The Six-Figure Creator":** Content creators, influencers, course sellers. $120K–$1M+, 1099, no entity, massive tax exposure.

**Tertiary — "The Healthcare Pro":** Private practice physicians, dentists, therapists. $200K–$600K, high malpractice exposure, needs PLLC + holding + trust.

**Quaternary — "The Business Builder":** Business owners $500K–$3M revenue. Messy structure, mixed credit, needs holding company + tax strategy + succession plan.

**ICP Scoring:** See `06_Brand/ideal-client-avatar.md` for full scoring matrix.
...
- "Most high earners have income. The wealthy have a system."
...
- Client: From $40K in taxes → IUL + trust + LLC in 60 days
- Client: $120,000 in business credit in 90 days, no personal guarantee
- Client: Pulled $25K from IUL tax-free during a slow quarter — no bank, no stress
...
2. Check `07_Operations/lead-pipeline.md` for current sprint status
3. Ask: "What are we working on today?" if no specific task is given
4. Reference the existing file structure before creating anything new — build on what's here
